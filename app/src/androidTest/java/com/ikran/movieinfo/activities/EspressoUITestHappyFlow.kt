...
class EspressoUITestHappyFlow {
    ...
    fun espressoUITestHappyFlow() {
        ...
        searchAutoComplete.perform(replaceText("daseart"), closeSoftKeyboard())
        Thread.sleep(1000)
        val searchAutoComplete2 = onView(
            allOf(
                withId(R.id.search_src_text), withText("daseart"),
                childAtPosition(
                    allOf(
                        withId(R.id.search_plate),
                        childAtPosition(
        ...
        searchAutoComplete4.perform(replaceText("star"), closeSoftKeyboard())
        Thread.sleep(1000)
        val searchAutoComplete5 = onView(
            allOf(
                withId(R.id.search_src_text), withText("star"),
                childAtPosition(
                    allOf(
                        withId(R.id.search_plate),
                        childAtPosition(
        ...
        searchAutoComplete7.perform(replaceText("friends"), closeSoftKeyboard())
        ...
        val searchAutoComplete8 = onView(
            allOf(
                withId(R.id.search_src_text), withText("friends"),
                childAtPosition(
                    allOf(
                        withId(R.id.search_plate),
                        childAtPosition(
